...
export default async function InventoryPage() {
  ...
  const activeRows = [
    ...(activeInventory ?? []).map((item) => ({
      ...
      pot_size: (item as Record<string, unknown>).pot_size as string | null ?? null,
    ...
    ...(listings ?? []).map((l) => ({
      ...
      pot_size: (l as Record<string, unknown>).pot_size as string | null ?? null,
      ends_at: null as string | null,
    ...
    ...(auctions ?? []).map((a) => ({
      ...
      pot_size: (a as Record<string, unknown>).pot_size as string | null ?? null,
      ends_at: a.ends_at,
